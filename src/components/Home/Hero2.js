...
export default function Hero() {
  ...
  const firstLineText =
    "India's first Health Identity Infrastructure™ ensures your complete medical history is always with you, in emergencies, in hospitals, across cities, across time.";
